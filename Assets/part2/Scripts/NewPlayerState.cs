...
public enum NewPlayerStateType
{
    MOVEMENT = 0,
    ATTACK,
    RELOAD,
...
//    public NewPlayerState(Player newPlayer)
//        : base()
//    {
//        mnPlayer = newPlayer;
//        mNFsm = mnPlayer.mNFsm;
//    }
...
public class NewPlayerState_MOVEMENT : PlayerState
{
    public NewPlayerState_MOVEMENT(Player player) : base(player)
    {
        mId = (int)(NewPlayerStateType.MOVEMENT);
    }
...
public class NewPlayerState_ATTACK : PlayerState
{
    ...
    public NewPlayerState_ATTACK(Player player) : base(player)
    {
...
public class NewPlayerState_RELOAD : PlayerState
{
    public float ReloadTime = 3.0f;
    float dt = 0.0f;
    public int previousState;
    public NewPlayerState_RELOAD(Player player) : base(player)
    {
